...
public class MyPetDelete extends JFrame implements ActionListener{
	...
	public MyPetDelete() {
		...
		JLabel main = new JLabel("반려견 정보 삭제");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == delete) {
			...
			if(!new MyPetManager().searchUpdate2(LoginScreen.myid, num)) {
				new DogManager().deletePet(num);
				new MyPetManager().deletePet(num);
